            ...
            {step === 2 && (
              <>
                ...
                <div className="flex justify-center w-full py-2">
                  <div className="relative group rounded-full transition-all duration-300 hover:shadow-[0_8px_25px_-5px_rgba(99,102,241,0.2)] hover:-translate-y-0.5">
                    <div className="absolute inset-0 rounded-full bg-gradient-to-r from-indigo-500/20 via-purple-500/20 to-indigo-500/20 opacity-0 group-hover:opacity-100 transition-opacity duration-300 blur-md"></div>
                    <div className="relative bg-white/5 p-[2px] rounded-full border border-white/10 group-hover:border-indigo-500/30 transition-colors duration-300">
                      <GoogleLogin
                        shape="pill"
                        text="continue_with"
                        size="large"
                        ...
                        onSuccess={async (credentialResponse) => {
                          ...
                          try {
                            ...
                            console.error(error)
                            setErrorMessage(error.response?.data?.message || "Failed to log in with Google")
                          } finally {
                            setIsLoading(false)
                          }
                        }}

...
import VehiclesParallaxBg from "@/components/VehiclesParallaxBg"
...
function HeroSection({ stats }: HeroSectionProps) {
  return (
    <section className="relative min-h-screen overflow-hidden pt-16">
      {/* Background mesh + grid on top of image */}
      <div className="absolute inset-0 gradient-mesh" style={{ zIndex: 1 }} />
      <div className="absolute inset-0 grid-pattern" style={{ opacity: 0.4, zIndex: 1 }} />

      {/* Animated Orbs */}
      <div className="absolute left-1/4 top-1/4 h-96 w-96 rounded-full bg-primary/10 blur-3xl" style={{ zIndex: 2 }} />
      <div className="absolute bottom-1/4 right-1/4 h-96 w-96 rounded-full bg-accent/10 blur-3xl" style={{ zIndex: 2 }} />

      <div className="relative mx-auto max-w-7xl px-4 py-24 sm:px-6 lg:px-8" style={{ zIndex: 3 }}>
...
function Footer() {
  return (
    <footer className="relative z-30 border-t border-border bg-card py-12">
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        <div className="grid gap-8 md:grid-cols-4">
          <div>
            <div className="flex items-center gap-2">
              <div className="flex h-9 w-9 items-center justify-center rounded-lg bg-primary"><div className="h-5 w-5 bg-primary-foreground" style={{ maskImage: "url('/Final_logo_transparent.png')", WebkitMaskImage: "url('/Final_logo_transparent.png')", maskSize: "contain", WebkitMaskSize: "contain", maskRepeat: "no-repeat", WebkitMaskRepeat: "no-repeat", maskPosition: "center", WebkitMaskPosition: "center" }} /></div>
              <span className="text-lg font-semibold text-foreground">
                ServiceFlow
              </span>
            </div>
...
export default function LandingPage() {
  ...
  return (
    <main className="min-h-screen noise-overlay">
      <VehiclesParallaxBg opacity={0.18} />
      <Navbar />
      ...
      {showSuccessModal && (
        <motion.div
          ...
          className="fixed bottom-8 right-8 z-50 glass-card p-6 rounded-2xl shadow-[0_10px_40px_rgba(var(--primary),0.3)] border border-primary/50 max-w-sm flex items-start gap-4"
        >
          <div className="w-10 h-10 rounded-full bg-primary/20 flex items-center justify-center text-primary shrink-0">
            <Check className="w-6 h-6" />
          </div>
          <div>
            <h3 className="text-lg font-bold text-foreground">Premium Activated!</h3>
            <p className="text-sm text-muted-foreground mt-1">Thank you for upgrading. Your premium features are now active.</p>
          </div>
        </motion.div>
      )}
    </main>
